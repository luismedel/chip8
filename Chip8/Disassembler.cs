...
namespace Chip8
{
    ...
    {
        static Dictionary<string, int[]> TABLE_GENERIC = new Dictionary<string, int[]> {
        ...
        static Dictionary<string, int[]> TABLE_0x0000 = new Dictionary<string, int[]> {
            { "clr", new int[] { 0xe0 } },
            { "rts", new int[] { 0xee } },
        };

        static Dictionary<string, int[]> TABLE_0x8000 = new Dictionary<string, int[]> {
        ...
        static Dictionary<string, int[]> TABLE_0xf000 = new Dictionary<string, int[]> {
        ...
        static Dictionary<string, string> OPERAND_FORMAT = new Dictionary<string, string> {
            { "jump", "0x{0:x3}" },
            { "call", "0x{0:x3}" },
            { "ske", "V{0:X}, 0x{1:x2}" },
            { "skne", "V{0:X}, 0x{1:x2}" },
